  ...
  _dec(
    (_class =
                        ...
                        switch ((_context.prev = _context.next)) {
                          case 0:
                            ...
                            if (this.username.trim().length > 42)
                              this.errors.username.push('用户名太长了');
                            if (this.username.trim().length < 4)
                              this.errors.username.push('用户名太短了'); // todo found的格式是什么？？
      ...
      (0, _applyDecoratedDescriptor2['default'])(
        ...
        [_dec9],
        Object.getOwnPropertyDescriptor(_class2.prototype, 'generatePasswordDigest'),
        _class2.prototype
      )),
      _class2))
  ) || _class);
