...
var Comment = (_dec = (0, _typeorm.Entity)(), _dec2 = (0, _typeorm.PrimaryGeneratedColumn)('increment'), _dec3 = (0, _typeorm.Column)('text'), _dec4 = (0, _typeorm.CreateDateColumn)('time'), _dec5 = (0, _typeorm.UpdateDateColumn)('time'), _dec6 = (0, _typeorm.ManyToOne)(function (type) {
  return _User.User;
}, function (user) {
